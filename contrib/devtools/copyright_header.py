...
EXCLUDE = [
    # auto generated:
    'src/qt/bitcoinclassicstrings.cpp',
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The BitcoinClassic developers'
...
Arguments:
    <base_directory> - The base directory of a bitcoinclassic source code repository.
"""
