...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-reindexmoneysupply", _("Reindex the IBTC and zIBTC money supply statistics") + " " + _("on startup"));
    ...
    strUsage += HelpMessageOpt("-ibtcstake=<n>", strprintf(_("Enable or disable staking functionality for IBTC inputs (0-1, default: %u)"), 1));
    ...
    strUsage += HelpMessageOpt("-precompute=<n>", strprintf(_("Enable precomputation of zIBTC spends and stakes (0-1, default %u)"), 1));
        ...
        do {
            try {
                ...
                if (GetBoolArg("-reindexmoneysupply", false) || reindexZerocoin) {
                    ...
                    RecalculateIBTCSupply(reindexZerocoin ? Params().Zerocoin_StartHeight() : 1);
                }
...
// ********************************************************* Step 8: load wallet
    ...
    /* Denominations
       ...
       For example:
       1IBTC+1000 == (.1IBTC+100)*10
       10IBTC+10000 == (1IBTC+1000)*10
    */
    ...
    if (pwalletMain) {
        ...
        if (GetBoolArg("-precompute", false)) {
            // Run a thread to precompute any zIBTC spends
