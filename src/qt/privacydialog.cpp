...
void PrivacyDialog::sendzIBTC()
{
    ...
    if(!fWholeNumber && fMintChange){
        ...
        strFeeWarning += QString::number(dzFee, 'f', 8) + " IBTC </b>will be added to the standard transaction fees!<br />";
...
void PrivacyDialog::updateSPORK16Status()
{
    ...
    if (fMaintenanceMode && fButtonsEnabled) {
        ...
        //ui->pushButtonMintzIBTC->setToolTip(tr("PrivacyDialog", "Enter an amount of IBTC to convert to zIBTC", 0));
