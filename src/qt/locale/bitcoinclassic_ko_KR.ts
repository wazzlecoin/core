...
자동 저장 기능이 활성화 된 경우이 비율은 구성된 자동 저장 비율 (기본값 = 10 %)을 기준으로 정해집니다.</translation>
    ...
    <message>
        ...
        <translation>자동생성 기능을 사용하지 않으시려면, improvedbitcoin.conf 화일에 enablezeromint=0 를 추가하세요.</translation>
    </message>
    <message>
...
- 활성화: 'enablezeromint=1' 를 improvedbitcoin.conf 파일에 추가
- 비활성화: 'enablezeromint=0' 를 improvedbitcoin.conf 파일에 추가
