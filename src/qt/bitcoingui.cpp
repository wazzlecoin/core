...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ImprovedBitcoin address"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ImprovedBitcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ImprovedBitcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ImprovedBitcoin addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the ImprovedBitcoin Core help message to get a list with possible ImprovedBitcoin command-line options"));
...
void BitcoinGUI::message(const QString& title, const QString& message, unsigned int style, bool* ret)
{
    ...
    // Append title to "ImprovedBitcoin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
