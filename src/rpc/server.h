...
extern UniValue DoZbxcSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzbxcseed(const UniValue& params, bool fHelp);
extern UniValue getzbxcseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzbxc(const UniValue& params, bool fHelp);
extern UniValue dzbxcstate(const UniValue& params, bool fHelp);
