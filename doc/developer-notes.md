...
- [Development guidelines](#development-guidelines)
    - [General ImprovedBitcoin Core](#general-improvedbitcoin-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
ImprovedBitcoin Core uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
ImprovedBitcoin Core is a multi-threaded application, and deadlocks or other
...
be sent upstream but bugfixes may also be prudent to PR against ImprovedBitcoin Core so that they can be integrated
...
file descriptors it will cause problems with ImprovedBitcoin's `select()` loop, because
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:ImprovedBitcoin-Project/ImprovedBitcoin.git
