...
- [Building BitcoinClassic](#building-improvedbitcoin)
...
git clone https://github.com/improvedbitcoin-crypto/improvedbitcoin.git
cd improvedbitcoin
...
```bash
    ...
    From https://github.com/improvedbitcoin-crypto/improvedbitcoin
...
For example:
```bash
URL=https://github.com/crowning-/improvedbitcoin.git
...
[improvedbitcoin/gitian.sigs](https://github.com/improvedbitcoin-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
