Contributing to BitcoinClassic Core
============================

The BitcoinClassic Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/bitcoinclassic-project/bitcoinclassic/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BitcoinClassic Core project, and is not to be
confused with overall BitcoinClassic Network Protocol consensus changes.

Whether a pull request is merged into BitcoinClassic Core rests with the project merge
...
Patches that change BitcoinClassic consensus rules are considerably more involved than
...
Where a patchset proposes to change the BitcoinClassic consensus, it must have been
...
The project leader is the release manager for each BitcoinClassic Core release.
